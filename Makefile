...
release-metadata-smoke:
	go test . -run 'Test(ChangelogReleaseHeadingsHaveMatchingTags|ReleaseSmokeDocsMentionMetadataGuard|PublicDocsLinkGoReference|PublicDocsMentionEcosystemSmoke|PublicDocsLinkRetrievalBenchmarksReference|PublicDocsSurfaceExternalAdapterContract|PublicDocsMentionBackendComparisonSmoke|BenchmarkDocsMentionConversationScopedBackendComparison|PublicAdoptionDocsMentionPublicModuleSmoke|PublicDocsMentionLatestReleaseVersion|PublicDocsUseLatestQualifiedGoGet|PublicDocsMentionPublishedReleaseDate|PublicDocsWarnRootGoInstallIsUnsupported|ReadmeSurfacesPkgGoDevEvaluationPath|ReadmeSurfacesPkgGoDevAPIMap|PackageDocsIncludeCompiledNewServiceExample|PackageDocsIncludeCompiledContextExample|PackageDocsIncludeCompiledSearchExample|ReleaseMetadataSmokeIncludesReadmePkgGoDevGuard|ReleaseMetadataSmokeIncludesReadmeAPIMapGuard|ReleaseMetadataSmokeIncludesPackageExampleGuard|ReleaseMetadataSmokeIncludesContextExampleGuard|ReleaseMetadataSmokeIncludesSearchExampleGuard|PublicDocsFrameRootModuleAsLibrary|EcosystemSmokeIncludesPublicReleaseMetadata|PublicReleaseSmokeChecksDocumentedLatestMetadata|PublicDocsExplainDocumentedLatestPublicReleaseSmoke|LocalModuleSmokeChecksGoModMetadata|PackageDocPointsPkgGoDevReadersToCompiledExamples|ReleaseMetadataSmokeIncludesPackageDocExamplesGuard|PackageDocSmokeChecksLocalGoDoc|DocsSiteSmokeBuildsPublicDocs|PublicDocsMentionDocsSiteSmoke|PublicDocsMentionPackageDocSmoke|PublicDocsMentionLocalModuleSmoke|PublicDocsMentionPublicReleaseSmoke)' -count=1
