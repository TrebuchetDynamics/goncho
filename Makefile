...
release-metadata-smoke:
	go test . -run 'Test(ChangelogReleaseHeadingsHaveMatchingTags|ReleaseSmokeDocsMentionMetadataGuard|PublicDocsLinkGoReference|PublicDocsMentionEcosystemSmoke|PublicDocsLinkRetrievalBenchmarksReference|PublicDocsSurfaceExternalAdapterContract|PublicDocsMentionBackendComparisonSmoke|BenchmarkDocsMentionConversationScopedBackendComparison|PublicAdoptionDocsMentionPublicModuleSmoke|PublicDocsMentionLatestReleaseVersion|PublicDocsUseLatestQualifiedGoGet|PublicDocsMentionPublishedReleaseDate|PublicDocsWarnRootGoInstallIsUnsupported|ReadmeSurfacesPkgGoDevEvaluationPath|ReadmeSurfacesPkgGoDevAPIMap|ReadmeSurfacesGoDevSignalMap|ReadmeSurfacesMinimalEmbeddedSkeleton|PackageDocsIncludeCompiledNewServiceExample|PackageDocsIncludeCompiledContextExample|PackageDocsIncludeCompiledSearchExample|ReleaseMetadataSmokeIncludesReadmePkgGoDevGuard|ReleaseMetadataSmokeIncludesReadmeAPIMapGuard|ReleaseMetadataSmokeIncludesReadmeGoDevSignalGuard|ReleaseMetadataSmokeIncludesReadmeMinimalSkeletonGuard|ReleaseMetadataSmokeIncludesPackageExampleGuard|ReleaseMetadataSmokeIncludesContextExampleGuard|ReleaseMetadataSmokeIncludesSearchExampleGuard|PublicDocsFrameRootModuleAsLibrary|EcosystemSmokeIncludesPublicReleaseMetadata|PublicReleaseSmokeChecksDocumentedLatestMetadata|PublicDocsExplainDocumentedLatestPublicReleaseSmoke|LocalModuleSmokeChecksGoModMetadata|PackageDocPointsPkgGoDevReadersToCompiledExamples|PackageDocSurfacesInstallAndCommandBoundary|PackageDocSurfacesPrimaryAPIPath|ReleaseMetadataSmokeIncludesPackageDocExamplesGuard|ReleaseMetadataSmokeIncludesPackageDocInstallGuard|ReleaseMetadataSmokeIncludesPackageDocAPIPathGuard|PackageDocSmokeChecksLocalGoDoc|DocsSiteSmokeBuildsPublicDocs|PublicDocsMentionDocsSiteSmoke|PublicDocsMentionPackageDocSmoke|PublicDocsMentionLocalModuleSmoke|PublicDocsMentionPublicReleaseSmoke)' -count=1
