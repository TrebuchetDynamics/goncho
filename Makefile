...
release-metadata-smoke:
	go test . -run 'Test(ChangelogReleaseHeadingsHaveMatchingTags|ReleaseSmokeDocsMentionMetadataGuard|PublicDocsLinkGoReference|PublicDocsMentionEcosystemSmoke|PublicAdoptionDocsMentionPublicModuleSmoke)' -count=1
