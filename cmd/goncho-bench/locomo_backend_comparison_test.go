...
`
	...
	writeTestFile(t, filepath.Join(dir, "metadata.json"), `{"source_url":"https://example.test/locomo","source_revision":"rev-test","source_sha256":"source-sha-test","license":"test license","converted_memories_sha256":"memories-sha-test","converted_questions_sha256":"questions-sha-test"}`)
	jsonOut := filepath.Join(dir, "locomo-backend-comparison.json")
	...
	assertBenchFileContains(t, mdOut, "- Source: `https://example.test/locomo` at `rev-test`")
	assertBenchFileContains(t, mdOut, "- Source SHA256: `source-sha-test`")
	assertBenchFileContains(t, mdOut, "- Converted memories SHA256: `memories-sha-test`")
