...
import (
	...
	"github.com/TrebuchetDynamics/goncho/cmd/goncho-bench/beam/shared/textnorm"
)
...
func NewQuestionKey(scale, conversationID, ability, question string) QuestionKey {
	return QuestionKey{
		Scale:          strings.TrimSpace(scale),
		ConversationID: strings.TrimSpace(conversationID),
		Ability:        textnorm.NormalizeAbility(ability),
		Question:       textnorm.NormalizeQuestionText(question),
	}
}
