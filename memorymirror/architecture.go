...
func toolManifest() []Capability {
	return []Capability{
		...
		tool("memory_snapshot_create", "service.ExportSnapshotManifest", PortAdapter, "deterministic manifest export is delivered; git snapshot storage is host-owned"),
		...
		tool("memory_slot_list", "service.ListMemorySlots", PortPartial, "service API exists; compatibility alias is not default-enabled yet"),
		tool("memory_slot_get", "service.GetMemorySlot", PortPartial, "service API exists; compatibility alias is not default-enabled yet"),
		tool("memory_slot_create", "service.CreateMemorySlot", PortPartial, "service API exists; mutating compatibility alias is not default-enabled yet"),
		tool("memory_slot_append", "service.AppendMemorySlot", PortPartial, "service API exists; mutating compatibility alias is not default-enabled yet"),
		tool("memory_slot_replace", "service.ReplaceMemorySlot", PortPartial, "service API exists; mutating compatibility alias is not default-enabled yet"),
		tool("memory_slot_delete", "service.DeleteMemorySlot", PortPartial, "service API exists; mutating compatibility alias is not default-enabled yet"),
	}
}
