...
func (t storeMemoryTool) Spec() OperationSpec {
...
func (t retrieveMemoryTool) Spec() OperationSpec {
	return memoryToolOperationSpec(t.Name(), t.Description(), t.Schema())
}
...
func (t updateMemoryTool) Spec() OperationSpec {
	return memoryToolOperationSpec(t.Name(), t.Description(), t.Schema())
}
...
func (t summarizeMemoryTool) Spec() OperationSpec {
	return memoryToolOperationSpec(t.Name(), t.Description(), t.Schema())
}
...
func (t forgetMemoryTool) Spec() OperationSpec {
	return memoryToolOperationSpec(t.Name(), t.Description(), t.Schema())
}
...
func memoryToolOperationSpec(name, description string, schema json.RawMessage) OperationSpec {
