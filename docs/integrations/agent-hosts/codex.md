...
Connector status contract: Codex support is local-first MCP configuration planning. Use `goncho connect codex --plan --config ~/.codex/config.toml --addr 127.0.0.1:8765` to preview the TOML patch.
