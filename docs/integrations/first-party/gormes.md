...
Connector status contract: Gormes is the canonical first-party integration path for Goncho. It is local-first and preview-first: use `goncho connect gormes --plan` before any host configuration change.
