...
func TestServerModeOperationalPackagingFilesStayLocalFirst(t *testing.T) {
	...
	smoke := mustReadGuardFile(t, "../../scripts/docker_compose_smoke.py")
	...
	makefile := mustReadGuardFile(t, "../../Makefile")
...
func TestDeploymentDocsNameConservativeTargetAndBackupRestore(t *testing.T) {
	doc := strings.ToLower(mustReadGuardFile(t, "../deployment-local-shared-service.md"))
