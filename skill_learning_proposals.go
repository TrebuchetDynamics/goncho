...
func (s *Service) ApproveSkillLearningProposal(ctx context.Context, p SkillLearningProposalReviewParams) (SkillLearningProposal, error) {
	...
	return reviewSkillLearningProposal(ctx, s.db, p, SkillLearningProposalApproved)
}
...
func (s *Service) RejectSkillLearningProposal(ctx context.Context, p SkillLearningProposalReviewParams) (SkillLearningProposal, error) {
	...
	return reviewSkillLearningProposal(ctx, s.db, p, SkillLearningProposalRejected)
}
...
func ensureSkillLearningProposalTable(ctx context.Context, db *sql.DB) error {
	...
	for _, stmt := range gonchoSkillLearningProposalDDL {
...
var gonchoSkillLearningProposalDDL = []string{
