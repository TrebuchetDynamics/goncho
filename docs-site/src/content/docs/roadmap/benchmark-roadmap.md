...
For runnable commands, current frozen artifacts, and external-backend adapter status, see [Retrieval Benchmarks](/reference/benchmarks/retrieval-benchmarks/). This roadmap stays focused on the longer evaluation sequence.
