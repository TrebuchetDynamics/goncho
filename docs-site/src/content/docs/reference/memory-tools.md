...
| `goncho_recall` | Run auditable service recall and return a scored `RecallTrace`, selected/rejected counts, warnings, deterministic replay evidence, and a compact diagnostics report. |
