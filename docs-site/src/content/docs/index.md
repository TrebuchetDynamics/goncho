...
Local ecosystem smoke: `make ecosystem-smoke` verifies public release metadata, local Go module metadata, package docs, external importability, and checkout-local benchmark CLI installation. For the narrower public release metadata proof, run `make public-release-smoke`; for the narrower local go.mod metadata proof, run `make local-module-smoke`; for the narrower external import proof, run `make public-module-smoke`.
