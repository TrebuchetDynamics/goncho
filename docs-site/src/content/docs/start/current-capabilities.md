...
- Tagged release stream: public `@latest` currently resolves to v0.3.2, published June 6, 2026; v0.3.x is the active release line for the importable service, Gormes adapter surface, and benchmark CLI.
