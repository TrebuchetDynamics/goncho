...
- Tagged release stream: public `@latest` currently resolves to v0.3.1, published June 1, 2026; v0.3.x is the active release line for the importable service, Gormes adapter surface, and benchmark CLI.
